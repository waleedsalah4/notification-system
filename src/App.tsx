  ...
  return (
    <main className="relative container flex min-h-screen flex-col items-center justify-center gap-10">
      <header className="flex flex-col items-center gap-4">
        ...
        <p className="text-lg text-gray-400">A customizable toast notification system for React and Angular with built-in animations, positioning, auto-dismiss, and more.</p>
