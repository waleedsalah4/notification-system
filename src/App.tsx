  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute top-1/3 -right-48 h-96 w-96 rounded-full bg-orange-600/10 blur-[100px]" />
        ...
        <main className="w-full space-y-6">
          ...
          <section className="glass-card p-8">
            <div className="mb-6">
              ...
              <p className="mt-1.5 text-sm text-gray-400">8 distinct variants — each with its own icon, color, and personality.</p>
            </div>
            <ToastButtons />
          </section>
          ...
          <section className="glass-card p-8">
            <div className="mb-6">
              ...
              <p className="mt-1.5 text-sm text-gray-400">Place toasts in any of 6 corners or centers. Swipe direction adapts automatically.</p>
            </div>
