              ...
              <tr key={prop.name}>
                <td className="py-3.5 pr-6">
                  <div className="flex items-center gap-2">
                    ...
                    {prop.required && <span className="rounded-full bg-violet-500/15 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-violet-400">required</span>}
                  </div>
                </td>
                <td className="py-3.5 pr-6">
                ...
                <td className="py-3.5 pr-6">
                  {prop.default === "—" ? <span className="text-gray-600">—</span> : <code className="rounded-md bg-white/6 px-2 py-1 font-mono text-xs text-amber-300">{prop.default}</code>}
                </td>
