  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: `${accentColor}20`, boxShadow: `0 0 14px ${accentColor}40`, color: accentColor }}
      >
      ...
      <div className="min-w-0 flex-1">
        {toast.title && <h5 className="text-sm font-semibold capitalize text-white">{toast.title}</h5>}
