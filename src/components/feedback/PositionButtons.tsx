...
function PositionButtons({ handlePositionChange, position }: Props) {
  ...
  const onPositionChange = (pos: TPosition) => {
    ...
    addToast({ ...toastsData.info, title: "Position changed", message: `Now showing at ${pos}` });
  };
  ...
  return (
    <div className="flex flex-wrap items-center gap-8">
      ...
      <div className="space-y-1">
        ...
        <p className="text-base font-semibold capitalize text-white">{position.replace("-", " ")}</p>
